...
AGENT_EVALUATION_CONFIG = {
    ...
    "fusion": {
        ...
        "reasoning_metrics": [
            m for m in ["reasoning_coherence", "reasoning_depth", "iterative_improvement"] if m in available_metrics
        ],
    },
    "naive": {
        "answer_metrics": [
    ...
    "deep": {
        ...
        "deeper_metrics": [
            m for m in ["knowledge_graph_utilization"] if m in available_metrics  # 仅适用于DeeperResearchTool
        ],
    },
}
