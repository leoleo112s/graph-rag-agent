...
def parse_args():
    ...
    parser.add_argument("--save_dir", type=str, default="./evaluation_results/deep_agent", help="评估结果保存目录")
    ...
    parser.add_argument("--metrics", type=str, default="", help="要评估的指标，用逗号分隔，留空则使用默认指标")
    parser.add_argument(
        "--eval_type",
        type=str,
        default="all",
    ...
    parser.add_argument("--use_deeper", action="store_true", help="是否使用增强版深度研究工具(DeeperResearchTool)")
