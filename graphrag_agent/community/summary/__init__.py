...
class CommunitySummarizerFactory:
    ...
    SUMMARIZERS = {"leiden": LeidenSummarizer, "sllpa": SLLPASummarizer}

    @classmethod
    def create_summarizer(cls, algorithm: str, graph: Neo4jGraph) -> BaseSummarizer:
        """
        创建社区摘要生成器实例
...
__all__ = ["CommunitySummarizerFactory", "BaseSummarizer", "LeidenSummarizer", "SLLPASummarizer"]
