...
from graphrag_agent.config.settings import GDS_CONCURRENCY, GDS_MEMORY_LIMIT, MAX_WORKERS
...
class BaseCommunityDetector(ABC):
    ...
    def _adjust_parameters(self):
        ...
        print(
            f"社区检测参数: CPU={MAX_WORKERS}, 内存={memory_gb:.1f}GB, "
    ...
    def process(self) -> Dict[str, Any]:
        ...
        results = {"status": "success", "algorithm": self.__class__.__name__, "details": {}}
        ...
        try:
            ...
            results.update({"status": "error", "error": str(e), "elapsed": time.time() - start_time})
            raise
