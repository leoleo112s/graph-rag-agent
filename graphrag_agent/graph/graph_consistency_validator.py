...
class GraphConsistencyValidator:
    ...
    def validate_graph(self) -> Dict[str, Any]:
        ...
        # 计算总问题数
        total_issues = orphan_count + dangling_count + empty_count + broken_doc_count + broken_chain_count
    ...
    def process(self, repair: bool = True) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"validation_result": validation_result, "total_time": self.validation_time}
