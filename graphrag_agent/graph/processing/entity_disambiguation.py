...
class EntityDisambiguator:
    ...
    def __init__(self):
        ...
        # 性能统计
        self.stats = {"mentions_processed": 0, "candidates_recalled": 0, "nil_detected": 0, "disambiguated": 0}
    ...
    def string_recall(self, mention: str, top_k: int = DISAMBIG_TOP_K) -> List[Dict[str, Any]]:
        ...
        results = self.graph.query(
            query, params={"mention": mention, "threshold": DISAMBIG_STRING_THRESHOLD, "top_k": top_k}
        )
    ...
    def disambiguate(self, mention: str) -> Dict[str, Any]:
        ...
        if not candidates:
            return {"mention": mention, "canonical_id": None, "is_nil": True, "candidates": []}
            ...
            for group in groups:
                ...
                if other_ids:
                    ...
                    result = self.graph.query(
                        update_query, params={"entity_ids": other_ids, "canonical_id": canonical_id}
                    )
