...
class EntityQualityProcessor:
    ...
    def __init__(self):
        ...
        # 性能统计
        self.stats = {"total_time": 0, "disambig_time": 0, "align_time": 0}
    ...
    def process(self) -> Dict[str, Any]:
        ...
        self._display_stats_table(
            "消歧统计", {"设置canonical_id的实体数": disambiguated, "耗时": f"{self.stats['disambig_time']:.2f}秒"}
        )
        ...
        return {"disambiguated": disambiguated, "aligned": align_result["entities_aligned"], "stats": self.stats}
